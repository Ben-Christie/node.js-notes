...
server.on('request', (req, res) => {
  ...
  if (req.method === 'POST' && items[1] === 'friends') {
    ...
    req.on('data', (data) => {
      // convet data to string, initially received as a buffer
...
// to test the POST method go to http://localhost:3000/friends and open the console, call the following fetch function:
...
// you would then send this data to a db to save it, we don't implement the that here so this will not save when the server stops
